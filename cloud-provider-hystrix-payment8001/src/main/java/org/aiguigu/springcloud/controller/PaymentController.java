...
public class PaymentController {
	...
	private static final String SERVICE_NAME="CLOUD-PAYMENT-SERVICE-HYSTRIX";
	...
	@GetMapping(value = "/payment/hystrix/meltdown/{id}")
	@ApiOperation("paymentCircuitBreaker")
	public String paymentCircuitBreaker(@ApiParam(name = "id", value = "id", required = true)  @PathVariable("id") Long id) {
